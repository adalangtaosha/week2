...
public class Merchandise_Static_Method {
    public String name;
    public String id;
    public int count;
    ...
    public static double getDiscountOnDiscount(Little_Market_Static_Method littleSuperMarket) {
        double activityDiscount = littleSuperMarket.activityDiscount;
        return DISCOUNT_FOR_VIP * activityDiscount;
    }

    public Merchandise_Static_Method(
    ...
    public Merchandise_Static_Method(String name, String id, int count, double soldPrice) {
