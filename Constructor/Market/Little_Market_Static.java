...
public class Little_Market_Static {
    public String superMarketName;
    public String address;
    public int parkingCount;
    public double incomingSum;
    public Merchandise_Static[] merchandises;
     ...
     */
    public Little_Market_Static(String superMarketName, String address, int parkingCount,
                             int merchandiseCount, int count) {
        this.superMarketName = superMarketName;
        this.address = address;
        this.parkingCount = parkingCount;

        merchandises = new Merchandise_Static[merchandiseCount];
        for (int i = 0; i < merchandises.length; i++) {
            double purchasePrice = Math.random() * 200;
            // 创建并给商品的属性赋值
            Merchandise_Static m = new Merchandise_Static(
                    "商品" + i,
                    "ID" + i,
                    count,
    ...
    public void setMerchandises(Merchandise_Static[] merchandises) {
     ...
     * @return
     */
    public Merchandise_Static getBiggestProfitMerchandise() {
        Merchandise_Static curr = null;
        for (int i = 0; i < merchandises.length; i++) {
            Merchandise_Static m = merchandises[i];
     ...
     * @return
     */
    public Merchandise_Static getMerchandiseOf(int merchandiseIndex) {
