...
public class Merchandise_Static {
    public String name;
    public String id;
    public int count;
    ...
    // >> TODO 静态变量一般使用  全大写字母加下划线   分割。这是一个习惯用法
    ...
    public Merchandise_Static(String name, String id, int count, double soldPrice, double purchasePrice) {
        this.name = name;
        this.id = id;
        this.count = count;
    ...
    public Merchandise_Static(String name, String id, int count, double soldPrice) {
        this(name, id, count, soldPrice, soldPrice * 0.8);
    }

    public Merchandise_Static() {
        this("无名", "000", 10, 8, 3);
