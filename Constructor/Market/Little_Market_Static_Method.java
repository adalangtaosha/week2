package week2.Constructor.Market;

public class Little_Market_Static_Method {
    public String superMarketName;
    public String address;
    public int parkingCount;
    public double incomingSum;
    public Merchandise_Static_Method[] merchandises;
     ...
     */
    public Little_Market_Static_Method(String superMarketName, String address, int parkingCount,
        ...
        merchandises = new Merchandise_Static_Method[merchandiseCount];
        for (int i = 0; i < merchandises.length; i++) {
            double purchasePrice = Math.random() * 200;
            // 创建并给商品的属性赋值
            Merchandise_Static_Method m = new Merchandise_Static_Method(
                    "商品" + i,
                    "ID" + i,
                    count,
    ...
    public void setMerchandises(Merchandise_Static_Method[] merchandises) {
     ...
     * @return
     */
    public Merchandise_Static_Method getBiggestProfitMerchandise() {
        Merchandise_Static_Method curr = null;
        for (int i = 0; i < merchandises.length; i++) {
            Merchandise_Static_Method m = merchandises[i];
            // 这个逻辑有问题吗？相同的利润怎么判断？
     ...
     * @return
     */
    public Merchandise_Static_Method getMerchandiseOf(int merchandiseIndex) {
